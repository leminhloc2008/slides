    ...
    def fit(self):
        ...
        self.model = keras.Sequential(
            [
                ...
                keras.layers.Dense(self._num_movies),
                keras.layers.Activation("softmax"),
            ]
        )
        self.model.compile(loss="mean_squared_error")
        print(liked_matrix_train.shape)
        print(self._num_movies)
        self.model.fit(
            liked_matrix_train, liked_matrix_train, epochs=30, validation_split=0.1
        )
